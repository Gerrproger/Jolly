...
_This function returns an Array of HTMLElements \(carousel target elements\) or_ `false` _if some error occurred. For example if browser is not supported._
...
| `selectors` | Object | [Refer source code](https://github.com/Gerrproger/Jolly/tree/a4f61523aaad6cb9a4d06479d3f00e9692610ad9/src/jolly.js#L35-L56) | You can override default `class` names if need to. |
...
You can easily stylize the whole carousel via extending CSS. All animations are performed using `transitions`. So all the effects and timings can be modified through CSS. Refer to the [jolly.css](https://github.com/Gerrproger/Jolly/tree/a4f61523aaad6cb9a4d06479d3f00e9692610ad9/src/jolly.css) to see how it works.
